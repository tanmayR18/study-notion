            ...
            <Tbody>
                {
                    course?.lenght === 0 ? (
                        ...
                        course?.map( course => (
                            <Tr 
                            key={course._id}
                            className = " flex gap-x-10 border-b border-b-richblack-800 px-6 py-8"
                            >
                                    ...
                                    <div className=' flex flex-col justify-between'>
                                        ...
                                        </p>
                                        {
                                            course.status === COURSE_STATUS.DRAFT ? (
                                                <div className=' flex w-fit flow-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-pink-100'>
                                                    <HiClock size={14} />   
                                                    Drafted
                                                </div>
                                            ) : (
                                ...
                                <Td className = " text-sm font-medium text-richblue-100 ">
                                    ...
                                    title='Edit'
                                    className=' px-2 transition-all duration-200 hover:text-caribbeangreen-300'
                                    >
                                        <FiEdit2 size={20} />
                                    </button>
                                    <button 
