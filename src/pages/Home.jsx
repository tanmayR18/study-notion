  ...
  return (
    ...
    text-white justify-between'>
      ...
      <Link to={"/signup"}>
        ...
        transition-all duration-200 hover:scale-95 w-fit border-b  border-[#FFFFFF2E] hover:border-none'>
      ...
      {/* Banner */}
      <div className=' w-full aspect-video relative mx-3 my-12'>
        ...
        {/* For bg white banner */}
        <div className='h-full z-10 w-full bg-white absolute -bottom-5 -right-5  '>
