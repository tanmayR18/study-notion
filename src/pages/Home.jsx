...
const Home = () => {
  return (
    ...
    <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center gap-8
    text-white justify-between'>

      {/* Instructor button */}
      <Link to={"/signup"}>
        <div className='group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]
      ...
      <div className=' w-full aspect-video relative mx-3 my-12 shadow-[10px_-5px_50px_-5px] shadow-blue-200'>
        ...
        {/* For bg white banner */}
        <div className=' hidden lg:block h-full z-10 w-full bg-white absolute -bottom-5 -right-5  '>
        ...
        <CodeBlock
          ...
          heading={
            <div className='text-4xl font-semibold'>
              Unlock Your
              <HighlightText text={"coding potential"} direction={"bg-gradient-to-b"} gradient={" from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"} />
      ...
      <div>
        <CodeBlock
          ...
          heading={
            <div className='text-4xl font-semibold'>
              Start
              <HighlightText text={"coding in"} direction={"bg-gradient-to-b"} gradient={" from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"} />
              <br/>
              <HighlightText text={"seconds"} direction={"bg-gradient-to-b"} gradient={" from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"} />
            </div>
          }
          subheading={
      ...
      <div className='w-11/12 max-w-maxContent mx-auto flex flex-col items-center justify-between gap-7'>
          ...
          <div className='flex lg:flex-row flex-col justify-evenly gap-5 mb-10 mt-[95px]'>
            <div className=' text-4xl font-semibold w-full lg:w-[45%]'>
              ...
              <HighlightText text={"job that is in demand"} direction={"bg-gradient-to-b"} gradient={" from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB]"} />
            </div>
